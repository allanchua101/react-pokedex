...
},{"fbjs/lib/ExecutionEnvironment":1,"fbjs/lib/containsNode":4,"fbjs/lib/emptyFunction":5,"fbjs/lib/emptyObject":6,"fbjs/lib/getActiveElement":7,"fbjs/lib/shallowEqual":13,"object-assign":21,"react":24}],20:[function(require,module,exports){
(function (process){
'use strict';
...
},{"fbjs/lib/emptyFunction":5,"fbjs/lib/emptyObject":6,"object-assign":25}],24:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./symbol/observable":32,"./util/pipe":41,"./util/root":42,"./util/toSubscriber":43}],27:[function(require,module,exports){
"use strict";
exports.empty = {
    closed: true,
    next: function (value) { },
...
},{"./Observable":26,"./SubjectSubscription":29,"./Subscriber":30,"./Subscription":31,"./symbol/rxSubscriber":33,"./util/ObjectUnsubscribedError":34}],29:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./Observer":27,"./Subscription":31,"./symbol/rxSubscriber":33,"./util/isFunction":38}],31:[function(require,module,exports){
"use strict";
...
},{"./util/UnsubscriptionError":35,"./util/errorObject":36,"./util/isArray":37,"./util/isFunction":38,"./util/isObject":39,"./util/tryCatch":44}],32:[function(require,module,exports){
"use strict";
var root_1 = require('../util/root');
...
},{"./noop":40}],42:[function(require,module,exports){
(function (global){
"use strict";
...
},{"../Observer":27,"../Subscriber":30,"../symbol/rxSubscriber":33}],44:[function(require,module,exports){
"use strict";
...
},{"./errorObject":36}],45:[function(require,module,exports){
'use strict';
...
var PokemonApiProxy = function () {
    function PokemonApiProxy() {
        _classCallCheck(this, PokemonApiProxy);
    }

    _createClass(PokemonApiProxy, [{
        key: 'loadData',
        value: function loadData(callback) {
            fetch('/data/pokedex.json').then(function (results) {
                return results.json();
            }).then(callback);
        }
    }]);

    return PokemonApiProxy;
}();

exports.default = PokemonApiProxy;

},{"react":24}],46:[function(require,module,exports){
'use strict';
...
var PokeTypeApiProxy = function () {
    function PokeTypeApiProxy() {
        _classCallCheck(this, PokeTypeApiProxy);
    }

    _createClass(PokeTypeApiProxy, [{
        key: 'loadData',
        value: function loadData(callback) {
            fetch('/data/types.json').then(function (results) {
                return results.json();
            }).then(callback);
        }
    }]);

    return PokeTypeApiProxy;
}();

exports.default = PokeTypeApiProxy;

},{"react":24}],47:[function(require,module,exports){
'use strict';
...
var _mainPanel = require('./widgets/main-panel.jsx');

var _mainPanel2 = _interopRequireDefault(_mainPanel);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom2.default.render(_react2.default.createElement(_mainPanel2.default, null), document.getElementById('app'));

},{"./widgets/main-panel.jsx":56,"react":24,"react-dom":20}],48:[function(require,module,exports){
"use strict";
...
var FilterByIdQuery = function () {
    function FilterByIdQuery() {
        _classCallCheck(this, FilterByIdQuery);
    }

    _createClass(FilterByIdQuery, [{
        key: "execute",
        value: function execute(data, id) {
            var output = [];
            ...
            if (id) {
                for (var i = 0, len = data.length; i < len; i++) {
                    ...
                    if (item.id.indexOf(id) > -1) output.push(item);
                }
            } else {
                output = data;
            }
    ...
    return FilterByIdQuery;
}();

exports.default = FilterByIdQuery;
...
var FilterByNameQuery = function () {
    function FilterByNameQuery() {
        _classCallCheck(this, FilterByNameQuery);
    }

    _createClass(FilterByNameQuery, [{
        key: "execute",
        value: function execute(data, name) {
            var output = [];

            if (name) {
                var smallCapsName = name.toLowerCase();

                for (var i = 0, len = data.length; i < len; i++) {
                    var item = data[i];

                    if (item.ename.toLowerCase().indexOf(smallCapsName) > -1) output.push(item);
                }
            } else {
                output = data;
            }
    ...
    return FilterByNameQuery;
}();

exports.default = FilterByNameQuery;
...
var FilterByPokeTypeQuery = function () {
    function FilterByPokeTypeQuery() {
        _classCallCheck(this, FilterByPokeTypeQuery);
    }

    _createClass(FilterByPokeTypeQuery, [{
        key: 'execute',
        value: function execute(data, pokeType) {
            var output = [];

            if (pokeType && pokeType.ename !== 'All') {
                var test = JSON.stringify(pokeType);

                for (var i = 0, len = data.length; i < len; i++) {
                    var item = data[i];

                    for (var t = 0, tlen = item.type.length; t < tlen; t++) {
                        var itemType = item.type[t];
    ...
    return FilterByPokeTypeQuery;
}();

exports.default = FilterByPokeTypeQuery;
;
...
var SortByID = function () {
    function SortByID() {
        _classCallCheck(this, SortByID);
    }

    _createClass(SortByID, [{
        key: 'execute',
        value: function execute(data) {
            var sortDirection = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'Ascending';
...
var SortByName = function () {
    function SortByName() {
        _classCallCheck(this, SortByName);
    }

    _createClass(SortByName, [{
        key: 'execute',
        value: function execute(data) {
            var sortDirection = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'Ascending';
...
function getFirstEnglishType(pokemon, poketypes) {
    ...
    for (var i = 0, len = poketypes.length; i < len; i++) {
        var test = JSON.stringify(poketypes[i]);

        for (var t = 0, tlen = pokemon.type.length; t < tlen; t++) {
...
var SortByType = function () {
    function SortByType() {
        _classCallCheck(this, SortByType);
    }

    _createClass(SortByType, [{
        key: 'execute',
        value: function execute(data, pokeTypes) {
            var sortDirection = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'Ascending';
...
var MessagingTopic = function () {
    function MessagingTopic() {
        _classCallCheck(this, MessagingTopic);

        this.subject = new _Subject.Subject();
        this.observable = this.subject.asObservable();
    }

    _createClass(MessagingTopic, [{
        key: 'publish',
...
exports.default = MessagingTopic;

},{"rxjs/Subject":28}],55:[function(require,module,exports){
"use strict";
...
var PaginationUtility = function () {
    function PaginationUtility() {
        _classCallCheck(this, PaginationUtility);
    }

    _createClass(PaginationUtility, [{
        key: "execute",
        value: function execute(pageSize, page, data) {
            var pageOffset = (page - 1) * pageSize;
            var lastItemIndex = pageOffset + pageSize;
            var dataClone = data;
...
var _sideNavigationBar = require('./side-navigation-bar.jsx');

var _sideNavigationBar2 = _interopRequireDefault(_sideNavigationBar);

var _pokemonCardFactory = require('./pokemon-card-factory.jsx');

var _pokemonCardFactory2 = _interopRequireDefault(_pokemonCardFactory);

var _pokePagerControl = require('./poke-pager-control.jsx');

var _pokePagerControl2 = _interopRequireDefault(_pokePagerControl);

var _searchBox = require('./search-box.jsx');

var _searchBox2 = _interopRequireDefault(_searchBox);

var _pokemonApiProxy = require('../api-proxies/pokemon-api-proxy.jsx');

var _pokemonApiProxy2 = _interopRequireDefault(_pokemonApiProxy);

var _poketypeApiProxy = require('../api-proxies/poketype-api-proxy.jsx');

var _poketypeApiProxy2 = _interopRequireDefault(_poketypeApiProxy);

var _messagingTopic = require('../pubsub/messaging-topic.jsx');

var _messagingTopic2 = _interopRequireDefault(_messagingTopic);

var _paginationUtility = require('../utils/pagination-utility.jsx');

var _paginationUtility2 = _interopRequireDefault(_paginationUtility);

var _filterByNameQuery = require('../isomorphic-queries/filter-by-name-query.jsx');

var _filterByNameQuery2 = _interopRequireDefault(_filterByNameQuery);

var _filterByPoketypeQuery = require('../isomorphic-queries/filter-by-poketype-query.jsx');

var _filterByPoketypeQuery2 = _interopRequireDefault(_filterByPoketypeQuery);

var _filterByIdQuery = require('../isomorphic-queries/filter-by-id-query.jsx');

var _filterByIdQuery2 = _interopRequireDefault(_filterByIdQuery);

var _sortByName = require('../isomorphic-queries/sort-by-name.jsx');

var _sortByName2 = _interopRequireDefault(_sortByName);

var _sortById = require('../isomorphic-queries/sort-by-id.jsx');

var _sortById2 = _interopRequireDefault(_sortById);

var _sortByType = require('../isomorphic-queries/sort-by-type.jsx');

var _sortByType2 = _interopRequireDefault(_sortByType);
...
function buildTopic(callback) {
    var topic = new _messagingTopic2.default();
...
function getNextState(instance, searchQuery, page, filter) {
    var pokemons = instance.pokemons;

    pokemons = new _filterByIdQuery2.default().execute(pokemons, filter.idQuery);
    pokemons = new _filterByNameQuery2.default().execute(pokemons, filter.nameQuery);
    pokemons = new _filterByNameQuery2.default().execute(pokemons, searchQuery);
    pokemons = new _filterByPoketypeQuery2.default().execute(pokemons, filter.typeQuery);

    switch (filter.sortField) {
        case 'Name':
            pokemons = new _sortByName2.default().execute(pokemons, filter.sortDirection);
            break;
        case 'Pokemon Type':
            pokemons = new _sortByType2.default().execute(pokemons, instance.state.poketypes, filter.sortDirection);
            break;
        case 'ID':
            pokemons = new _sortById2.default().execute(pokemons, filter.sortDirection);
            break;
    }

    return new _paginationUtility2.default().execute(instance.state.pageSize, page, pokemons);
}

function handleFilterMessages(instance) {
    return buildTopic(function (msg) {
        var nextState = getNextState(instance, instance.state.searchQuery, DEFAULT_PAGE, msg);
...
function handleSearchMessages(instance) {
    return buildTopic(function (msg) {
        var nextState = getNextState(instance, msg, DEFAULT_PAGE, instance.state);
...
function handlePagingMessages(instance) {
    return buildTopic(function (msg) {
        var nextState = getNextState(instance, instance.state.searchQuery, msg.value, instance.state);
...
function loadPokemons(instance) {
    if (instance.pokemons.length === 0) {
        new _pokemonApiProxy2.default().loadData(function (data) {
            var nextState = new _paginationUtility2.default().execute(instance.state.pageSize, instance.state.page, data);
...
function loadTypes(instance) {
    if (instance.state.poketypes.length === 0) {
        new _poketypeApiProxy2.default().loadData(function (data) {
            instance.setState({
                poketypes: data
            });
        });
...
var MainPanel = function (_React$Component) {
    ...
    function MainPanel() {
        ...
        _this.state = buildDefaultState();
        _this.pokemons = [];

        _this.pagingTopic = handlePagingMessages(_this);
        _this.searchTopic = handleSearchMessages(_this);
        _this.filterTopic = handleFilterMessages(_this);
        return _this;
    }
    ...
    _createClass(MainPanel, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_sideNavigationBar2.default, { filterTopic: this.filterTopic, poketypes: this.state.poketypes }),
                _react2.default.createElement(
                    'h1',
                    { id: 'page-title' },
                    'POKEDEX'
                ),
                _react2.default.createElement(_searchBox2.default, { searchTopic: this.searchTopic }),
                _react2.default.createElement('div', { className: 'clearfix' }),
                _react2.default.createElement(_pokemonCardFactory2.default, { pokemons: this.state.pageItems, poketypes: this.state.poketypes }),
                _react2.default.createElement('div', { className: 'clearfix' }),
                _react2.default.createElement(_pokePagerControl2.default, { currentPage: this.state.page, totalPages: this.state.totalPages,
...
},{"../api-proxies/pokemon-api-proxy.jsx":45,"../api-proxies/poketype-api-proxy.jsx":46,"../isomorphic-queries/filter-by-id-query.jsx":48,"../isomorphic-queries/filter-by-name-query.jsx":49,"../isomorphic-queries/filter-by-poketype-query.jsx":50,"../isomorphic-queries/sort-by-id.jsx":51,"../isomorphic-queries/sort-by-name.jsx":52,"../isomorphic-queries/sort-by-type.jsx":53,"../pubsub/messaging-topic.jsx":54,"../utils/pagination-utility.jsx":55,"./poke-pager-control.jsx":59,"./pokemon-card-factory.jsx":60,"./search-box.jsx":62,"./side-navigation-bar.jsx":63,"react":24}],57:[function(require,module,exports){
"use strict";
...
var MaterializedSelect = function (_React$Component) {
    _inherits(MaterializedSelect, _React$Component);

    function MaterializedSelect() {
        _classCallCheck(this, MaterializedSelect);

        return _possibleConstructorReturn(this, (MaterializedSelect.__proto__ || Object.getPrototypeOf(MaterializedSelect)).apply(this, arguments));
    }

    _createClass(MaterializedSelect, [{
        key: "render",
        value: function render() {
            var _props = this.props,
                ...
                name = _props.name,
                textProperty = _props.textProperty,
                keyProperty = _props.keyProperty,
                onChange = _props.onChange;

            var templatedItems = items.map(function (item) {
                return _react2.default.createElement(
                    "option",
                    { key: item[keyProperty], value: stringify(item) },
                    item[textProperty]
                );
            });
    ...
    return MaterializedSelect;
}(_react2.default.Component);

exports.default = MaterializedSelect;
;

},{"react":24}],58:[function(require,module,exports){
'use strict';
...
var PokePagerButton = function (_React$Component) {
    _inherits(PokePagerButton, _React$Component);

    function PokePagerButton() {
        _classCallCheck(this, PokePagerButton);

        return _possibleConstructorReturn(this, (PokePagerButton.__proto__ || Object.getPrototypeOf(PokePagerButton)).apply(this, arguments));
    }

    _createClass(PokePagerButton, [{
        key: 'render',
        value: function render() {
            var _props = this.props,
                text = _props.text,
                ...
                value = _props.value,
                _props$isVisible = _props.isVisible,
                isVisible = _props$isVisible === undefined ? true : _props$isVisible;


            return _react2.default.createElement(
                'button',
                { className: 'poke-pager-button ' + (currentPage === text ? ' active' : ' ') + (isVisible ? ' ' : ' hidden'),
                    onClick: onClick,
                    title: tooltip,
                    value: value },
                text
    ...
    return PokePagerButton;
}(_react2.default.Component);

exports.default = PokePagerButton;

},{"react":24}],59:[function(require,module,exports){
'use strict';
...
var _pokePagerButton = require('./poke-pager-button.jsx');

var _pokePagerButton2 = _interopRequireDefault(_pokePagerButton);
...
var PokePagerControl = function (_React$Component) {
    _inherits(PokePagerControl, _React$Component);

    function PokePagerControl(props) {
        _classCallCheck(this, PokePagerControl);

        var _this = _possibleConstructorReturn(this, (PokePagerControl.__proto__ || Object.getPrototypeOf(PokePagerControl)).call(this));

        _this.pagingTopic = props.pagingTopic;
        _this.onNextPage = _this.onNextPage.bind(_this);
        _this.onPreviousPage = _this.onPreviousPage.bind(_this);
        _this.onGoToLastPage = _this.onGoToLastPage.bind(_this);
        _this.onGoToFirstPage = _this.onGoToFirstPage.bind(_this);
        _this.onGoToTargetPage = _this.onGoToTargetPage.bind(_this);
        return _this;
    }

    _createClass(PokePagerControl, [{
        key: 'goToPage',
        ...
        key: 'onGoToFirstPage',
        value: function onGoToFirstPage() {
            this.goToPage(1);
        }
    }, {
        key: 'onGoToLastPage',
        value: function onGoToLastPage() {
            this.goToPage(this.props.totalPages);
        }
    }, {
        key: 'onGoToTargetPage',
        value: function onGoToTargetPage(evt) {
            this.goToPage(parseInt(evt.target.value));
        }
    }, {
        key: 'onNextPage',
        value: function onNextPage() {
            var targetPage = this.props.currentPage;

            if (targetPage < this.props.totalPages) targetPage += 1;
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                _props$totalPages = _props.totalPages,
                totalPages = _props$totalPages === undefined ? 0 : _props$totalPages,
                _props$pageSize = _props.pageSize,
                pageSize = _props$pageSize === undefined ? 10 : _props$pageSize;

            var pagePosition = currentPage % 5;
            var firstPage = pagePosition === 0 ? currentPage - 5 : currentPage - pagePosition;
            var pages = [1, 2, 3, 4, 5].map(function (id) {
                var pageId = firstPage + id;

                return _react2.default.createElement(_pokePagerButton2.default, { key: id, text: pageId, currentPage: currentPage,
                    value: pageId, onClick: _this2.onGoToTargetPage,
                    isVisible: pageId <= totalPages });
            });

            return _react2.default.createElement(
                'div',
                { className: 'poke-pager-control ' + (totalPages <= 1 ? 'hidden' : '') },
                _react2.default.createElement(_pokePagerButton2.default, { text: '<<', tooltip: 'Go to first page', onClick: this.onGoToFirstPage }),
                _react2.default.createElement(_pokePagerButton2.default, { text: '<', tooltip: 'Go to previous page', onClick: this.onPreviousPage }),
                pages,
                _react2.default.createElement(_pokePagerButton2.default, { text: '>', tooltip: 'Go to next page', onClick: this.onNextPage }),
                _react2.default.createElement(_pokePagerButton2.default, { text: '>>', tooltip: 'Go to last page', onClick: this.onGoToLastPage })
            );
        }
    }]);

    return PokePagerControl;
}(_react2.default.Component);

exports.default = PokePagerControl;

},{"./poke-pager-button.jsx":58,"react":24}],60:[function(require,module,exports){
'use strict';
...
var _pokemonCard = require('./pokemon-card.jsx');
...
var PokemonCardFactory = function (_React$Component) {
    _inherits(PokemonCardFactory, _React$Component);

    function PokemonCardFactory() {
        _classCallCheck(this, PokemonCardFactory);

        var _this = _possibleConstructorReturn(this, (PokemonCardFactory.__proto__ || Object.getPrototypeOf(PokemonCardFactory)).call(this));
        ...
        _this.pokemonCardBus = new _messagingTopic2.default();
        _this.pokemonCardBus.subscribe(function (msg) {
            instance.setState({
    ...
    _createClass(PokemonCardFactory, [{
        key: 'render',
        value: function render() {
            var _this2 = this;
            ...
            var _props = this.props,
                ...
                poketypes = _props.poketypes;

            var visibleItems = pokemons.map(function (pokemon) {
                return _react2.default.createElement(_pokemonCard2.default, { key: pokemon.id, data: pokemon, messageBus: _this2.pokemonCardBus,
                    types: getPokeTypes(pokemon, poketypes),
                    isVisible: _this2.state.mode === 'SHOW ALL' || pokemon.id === _this2.state.visiblePokeCardId,
                    isExpanded: _this2.state.mode !== 'SHOW ALL' && pokemon.id === _this2.state.visiblePokeCardId });
            });
...
exports.default = PokemonCardFactory;

},{"../pubsub/messaging-topic.jsx":54,"./pokemon-card.jsx":61,"react":24}],61:[function(require,module,exports){
'use strict';
...
function fixBrokenImageNames(pokemonName) {
    var brokenNames = ['Nidoran♀', 'Nidoran♂', 'Farfetch\'d', 'Mr. Mime', 'Mime Jr.', 'Flabébé'];
    var fixedNames = ['Nidoran', 'Nidoran', 'Farfetchd', 'Mr_Mime', 'Mime_Jr', 'Flabebe'];
    var searchIndex = brokenNames.indexOf(pokemonName);

    if (searchIndex > -1) return fixedNames[searchIndex];
...
var PokemonCard = function (_React$Component) {
    ...
    function PokemonCard(props) {
        ...
        var _this = _possibleConstructorReturn(this, (PokemonCard.__proto__ || Object.getPrototypeOf(PokemonCard)).call(this));

        _this.onPokemonCardTapped = _this.onPokemonCardTapped.bind(_this);
        _this.onPokemonCardClosed = _this.onPokemonCardClosed.bind(_this);
        return _this;
    }

    _createClass(PokemonCard, [{
        key: 'onPokemonCardTapped',
        value: function onPokemonCardTapped(evt) {
        ...
        key: 'onPokemonCardClosed',
        value: function onPokemonCardClosed(evt) {
            this.props.messageBus.publish({
                event: 'SHOW ALL',
                originId: this.props.data.id
            });
        ...
        value: function render() {
            ...
            var imageUrl = '/images/thm/' + data.id.toString() + fixBrokenImageNames(data.ename) + '.png';
            var spriteUrl = '/images/spr/' + data.id.toString() + 'MS.png';

            if (this.props.isExpanded) imageUrl = '/images/img/' + data.id.toString() + fixBrokenImageNames(data.ename) + '.png';

            return _react2.default.createElement(
                'div',
                { className: 'pokemon-card' + (isVisible ? '' : ' collapsed') + (isExpanded ? ' expanded' : ''),
                    title: 'Tap to see details', onClick: this.onPokemonCardTapped },
                _react2.default.createElement('img', { src: imageUrl, className: 'avatar' }),
                _react2.default.createElement('img', { src: spriteUrl, className: 'sprite' }),
                _react2.default.createElement('a', { href: '#', className: 'close-marker', onClick: this.onPokemonCardClosed }),
                _react2.default.createElement(
                    'div',
                    ...
                    _react2.default.createElement(
                        'p',
                        { className: 'card-prop show-on-expand' },
                        types.map(function (type) {
                            return _react2.default.createElement(
                                'span',
                                { key: type, className: 'type-tag' },
                                type
                            );
                        })
                    ),
...
},{"react":24}],62:[function(require,module,exports){
'use strict';
...
var SearchBox = function (_React$Component) {
    ...
    function SearchBox(props) {
        ...
        _this.searchTopic = props.searchTopic;
    ...
    _createClass(SearchBox, [{
        key: 'onSearchChanged',
        value: function onSearchChanged(evt) {
            this.searchTopic.publish(evt.target.value);
        }
    }, {
        key: 'render',
        value: function render() {
            return _react2.default.createElement('input', { className: 'search-box', placeholder: 'Search by pokemon name...',
...
},{"react":24}],63:[function(require,module,exports){
'use strict';
...
var _materializedSelect = require('./materialized-select.jsx');

var _materializedSelect2 = _interopRequireDefault(_materializedSelect);
...
var SideNav = function (_React$Component) {
    ...
    function SideNav(props) {
        ...
        _this.typeQuery = null;
        _this.idQuery = null;
        _this.searchQuery = null;
        _this.sortField = 'ID';
        _this.sortDirection = 'Ascending';
        _this.filterTopic = props.filterTopic;
        _this.onPokeTypeChanged = _this.onPokeTypeChanged.bind(_this);
        _this.onPokeIdChanged = _this.onPokeIdChanged.bind(_this);
        _this.onPokeNameChanged = _this.onPokeNameChanged.bind(_this);
        _this.onSortFieldChanged = _this.onSortFieldChanged.bind(_this);
        _this.onSortDirectionChanged = _this.onSortDirectionChanged.bind(_this);
        _this.onHamburgerClicked = _this.onHamburgerClicked.bind(_this);
        return _this;
    }
    ...
    _createClass(SideNav, [{
        ...
        key: 'onPokeNameChanged',
        value: function onPokeNameChanged(evt) {
            this.nameQuery = evt.target.value;
            this.publishEvent();
        }
    }, {
        key: 'onPokeTypeChanged',
        value: function onPokeTypeChanged(evt) {
            this.typeQuery = JSON.parse(evt.target.value);
            this.publishEvent();
        }
    }, {
        key: 'onPokeIdChanged',
        value: function onPokeIdChanged(evt) {
            this.idQuery = evt.target.value;
            this.publishEvent();
        }
    }, {
        key: 'onSortFieldChanged',
        value: function onSortFieldChanged(evt) {
            this.sortField = JSON.parse(evt.target.value).Name;
            this.publishEvent();
        }
    }, {
        key: 'onSortDirectionChanged',
        value: function onSortDirectionChanged(evt) {
            this.sortDirection = JSON.parse(evt.target.value).Name;
            this.publishEvent();
        }
    }, {
        key: 'onHamburgerClicked',
        value: function onHamburgerClicked() {
            this.setState({
        ...
        key: 'render',
        value: function render() {
            var poketypes = this.props.poketypes;
            ...
            return _react2.default.createElement(
                'div',
                { className: 'side-nav-bar ' + (this.state.isOpened ? 'opened' : '') },
                _react2.default.createElement(
                    'div',
                    { className: 'hamburger-menu ' + (this.state.isOpened ? 'opened' : ''), onClick: this.onHamburgerClicked },
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', { type: 'text', className: 'filter-box', onChange: this.onPokeIdChanged, placeholder: 'ID', required: 'required' }),
                    _react2.default.createElement('input', { type: 'text', className: 'filter-box', onChange: this.onPokeNameChanged, placeholder: 'Pokemon Name', required: 'required' }),
                    _react2.default.createElement(_materializedSelect2.default, { items: items, textProperty: 'ename', keyProperty: 'ename',
                    ...
                    _react2.default.createElement(_materializedSelect2.default, { items: buildSortFields(), textProperty: 'Name', keyProperty: 'Name',
                    ...
                    _react2.default.createElement(_materializedSelect2.default, { items: buildSortDirections(), textProperty: 'Name', keyProperty: 'Name',
...
},{"./materialized-select.jsx":57,"react":24}]},{},[47]);
